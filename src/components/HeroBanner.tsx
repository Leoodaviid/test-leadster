...
const HeroBanner = () => {
  return (
    <section
      ...
      className="bg-[#f0f8ff] w-full flex flex-col justify-center items-center py-10 px-2 gap-1 sm:gap-2 sm:py-16 md:py-24"
    >
      ...
      <p className="font-bold text-zinc-700 text-[9px] sm:text-xs md:text-sm lg:text-base">
        ...
        <strong className="font-extrabold text-black">mudaram o jogo</strong> e
